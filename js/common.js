        ...
        $(function () {
            if ($('#map').length > 0) { // #map - id conteiner
                jQuery(function ($) {
                    ...
                    // Tallinn
                    var lat = 59.435673; // latitude
                    var lng = 24.756776; // longitude
                    var position = new google.maps.LatLng(lat, lng);
                    var center = new google.maps.LatLng(lat, lng);
                    var drag = true;

                    // SPB
                    var lat = 59.995095; // latitude
                    var lng = 30.334461; // longitude
                    var position_spb = new google.maps.LatLng(lat, lng);
                    var center = new google.maps.LatLng(lat, lng);
                    var drag = true;


                    // Kiev
                    var lat = 50.448759; // latitude
                    var lng = 30.531998; // longitude
                    var position_kiev = new google.maps.LatLng(lat, lng);
                    var center = new google.maps.LatLng(lat, lng);
                    var drag = true;
                    ...
                    // Spb Images
                    var image_spb = 'images/main/marker-spb.png'; // icon map image
                    var beachMarker = new google.maps.Marker({
                        position: position_spb,
                        map: map,
                        icon: image_spb
                    });
                    // Kiev Images
                    var image_kiev = 'images/main/marker-kiev.png'; // icon map image
                    var beachMarker = new google.maps.Marker({
                        position: position_kiev,
                        map: map,
                        icon: image_kiev
                    });
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        map: map,
                        icon: image_spb,
                        title: 'Sankt-Peterburg' // marker text
                    });
